...
""" PPO code based on cleanRL implementation
...
class Args:
    def __init__(self):
        ...
        self.wandb_project_name: str = "PPO_cleanRL"
        ...
        self.env_id: str = "BreakoutNoFrameskip-v4"
        self.total_timesteps: int = 10000000
        self.learning_rate: float = 2.5e-4
        self.num_envs: int = 8  # 8
        self.num_steps: int = 128  # 128
        ...
        self.num_minibatches: int = 4  # 4
        """the number of mini-batches"""
        self.update_epochs: int = 4  # 4
...
class Agent(nn.Module):
    ...
    def get_action_and_value(self, x, action=None):
        ...
        return action, probs.log_prob(action), probs.entropy(), self.critic(hidden), exploration
...
def main():
    ...
    # envs = gym.vector.make(args.env_id, num_envs=args.num_envs, wrappers=AtariPreprocessing)
    ...
    for iteration in range(1, args.num_iterations + 1):
        ...
        for step in range(0, args.num_steps):
            ...
            with torch.no_grad():
                action, logprob, _, value, explore = agent.get_action_and_value(next_obs)
        ...
        for epoch in range(args.update_epochs):
            ...
            for start in range(0, args.batch_size, args.minibatch_size):
                ...
                _, newlogprob, entropy, newvalue, explore = agent.get_action_and_value(b_obs[mb_inds], b_actions.long()[mb_inds])
